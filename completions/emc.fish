...
complete --command $EMC_CMD --no-files --arguments add      --condition "__fish_use_subcommand" --description "Add a new config file option: `add <name> <path>`. <path> must be relative to ~/"
complete --command $EMC_CMD --no-files --arguments remove   --condition "__fish_use_subcommand" --description "Remove a config file  option `remove <name>`"
